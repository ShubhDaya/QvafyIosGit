...
class PaymentMethodVC: UIViewController ,UITextFieldDelegate {
    ...
    @IBOutlet weak var vwSubCOD: UIView!
    ...
    @IBOutlet weak var lblLOCashOnDeliery: UILabel!
    @IBOutlet weak var lblLOOr: UILabel!
    ...
    @IBOutlet weak var btnLODone: UIButton!
    ...
    override func viewDidLoad() {
        ...
        self.vwSubCOD.setShadowWithCornerRadius()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if  objAppShareData.isFromCartList == true {
            ...
            self.vwCOD.isHidden = true
        }else{
            print(" is From mapVC ")
            self.vwCOD.isHidden = false
        }
    ...
    func localisation(){
        ...
        self.lblLOPaymentMethod.text = "Payment Methods".localize
        self.lblLOCashOnDeliery.text = "Cash_On_Delivery".localize
        self.lblLOOr.text = "OR".localize
        ...
        self.btnLODone.setTitle("Done".localize, for: .normal)
    ...
    @IBAction func btnBack(_ sender: UIButton) {
          ...
          objAppShareData.isFromPayment = true
    ...
    @IBAction func btnDone(_ sender: UIButton) {
        ...
        } else if self.imgCod.image == #imageLiteral(resourceName: "selected_ico") {
            
            self.strPaymentMethod = "1"
...
//            objAppShareData.strPaymentMethod = "1"
    ...
    @IBAction func btnCodData(_ sender: UIButton) {
        self.view.endEditing(true)
        if self.imgCod.image == #imageLiteral(resourceName: "deselect_ico") {
            self.imgCod.image = #imageLiteral(resourceName: "selected_ico")
            self.strId = ""
        } else{
...
extension PaymentMethodVC : UITableViewDelegate ,UITableViewDataSource {
    ...
    @objc func buttonClicked(sender:UIButton) {
        ...
        if self.arrCardList.count > 0 {
              ...
              self.strId = obj.strStripeCardId
             self.tblCardList.reloadData()
           }
    }
...
extension PaymentMethodVC : UIPickerViewDelegate,UIPickerViewDataSource {
